...
// Catches errors in the client portal. Renders inside the root layout.
export default function ClientError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
    if (typeof console !== "undefined") {
        console.error("Client portal error:", error.digest ?? error.message);
    }
    return (
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 bg-slate-50">
            <div className="w-full max-w-md text-center">
                ...
                <p className="mt-2 text-slate-500">
                    Something went wrong loading the client dashboard. Try again, or reload the page.
                </p>
